...
export type MidiMappingTarget =
  ...
  | 'shader.distortion' | 'particles.size' | 'particles.spread' | 'particles.speed' | 'particles.decay'
...
export const defaultMidiMappings: MidiMapping[] = [
  ...
  { label: 'Knob 2 / particle size', type: 'controlchange', controller: 71, target: 'particles.size' },
  ...
  { label: 'Mod wheel', type: 'controlchange', controller: 1, target: 'controls.modWheel' },
